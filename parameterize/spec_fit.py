...
def sphere_fit_fun(hbarw, eps_inf, hbarw_p, hbargamma, a, eps_b=eps_water):
...
def sphere_dip_cost_fun(params, *args,
    ...
    yfit = (
        sphere_fit_fun(x, *params[:4], eps_b=eps_b)
        )
...
def hiengau_cost_func(params, *args, data_scale_to_cgs=cm_per_nm**2, data_oom=1e-10):
    """ Cost function for fitting sphere dipole polarizability with a higher energy gaussian
        """
    ## Argumens contain independent and dependent varualbles.
    x=args[0]
